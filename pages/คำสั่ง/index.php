            ...
            <form name="sent_form" method="post" id="form">
                ...
                <span id="block_tab_1" style="display: inline">
                      ...
                      <tr>
                        ...
                        <td colspan="2" style="text-align:center">
                          <span class="span_image">
                            <img src="../../images/memo.png" class="image_logo" title="ตราครุฑ"/>
                          </span>
                        </td>
                        <td colspan="2"></td>
                      </tr>
                    ...
                    <p class="MsoNormal py-2" align="center" style="margin-bottom: 0cm; text-align: center; line-height: normal">
                      <span class="c16">ที่&nbsp;<input placeholder="" type="text" class="py-0  border border-slate-300 "  name="government" id="government" value="" onblur="checkVal(this)" autocomplete="off" /></span>
                    </p>
              
                    <p class="MsoNormal" align="center" style="margin-bottom: 0cm; text-align: center; line-height: normal">
                      <span class="c16">เรื่อง&nbsp;&nbsp;
                    ...
                    <textarea hidden name="name3" id="editor"></textarea>
