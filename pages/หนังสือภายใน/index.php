                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td width="85%" align="left" valign="bottom" class="memo-border-bottom">
                                                                                    <input type="text" class="w-full  py-2 border border-slate-300" name="government" id="government" value="" onblur="checkVal(this)" autocomplete="off" />
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td width="47%" align="center" valign="bottom" class="memo-border-bottom">
                                                                                    <input type="text" class="w-full  py-2 border border-slate-300" name="at" id="at" value="" onblur="checkVal(this)" autocomplete="off" />
                                                                                </td>
                                                                                ...
                                                                                <td width="45%" align="center" valign="bottom" class="memo-border-bottom" style="padding-left: 20px">
                                                                                    <input type="text" class="w-full  py-2 border border-slate-300" name="date" id="date" value="" onblur="checkVal(this)" autocomplete="off" />
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td width="92%" align="left" valign="bottom" class="memo-border-bottom">
                                                                                    <input class="w-full  py-2 border border-slate-300" type="text" name="subject" value="" id="subject" autocomplete="off" onblur="checkVal(this)" />
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td width="92%" align="left" valign="bottom" class="memo-border-bottom" style="border: none">
                                                                                    <input class="w-full  py-2 border border-slate-300" type="text" onblur="checkVal(this)" name="learn" id="learn" value="" autocomplete="off" />
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
