          ...
          <page size="A4" id="page0">
            <div class="memo-form">
              ...
              <p class="mt-2" style="margin-bottom: 0cm; text-align: center; line-height: normal">
                <span class="c16"></span>
                <span class="c16 font-bold">ระเบียบ&nbsp;&nbsp;
                </span>
              ...
              <p class="MsoNormal py-2" align="center" style="margin-bottom: 0cm; text-align: center; line-height: normal">
                <span class="c16 font-bold">ว่าด้วย&nbsp;</span><input placeholder="" type="text" class="py-0  border border-slate-300 w-80" name="at" id="at" value="" onblur="checkVal(this)" autocomplete="off" />
              </p>

              <p class="MsoNormal" align="center" style="margin-bottom: 0cm; text-align: center; line-height: normal">
                <span class="c16 font-bold">พ.ศ. &nbsp;&nbsp;

                </span>
                <input placeholder="" type="text" class="py-0 border border-slate-300 w-40" name="subject" id="subject" value="" onblur="checkVal(this)" autocomplete="off" />
              </p>
              ...
              <div id="orderFooter" class="mt-5">
                <!-- <p class="MsoNormal" style="
                  ...
                  text-indent: 2.5cm;
                ">
                  <span class="c16">ประกาศ&nbsp;&nbsp;ณ&nbsp;&nbsp;วันที่&nbsp;
